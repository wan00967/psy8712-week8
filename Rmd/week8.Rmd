...
An image of this project as of *`r Sys.Date()`* can be accessed by clicking https://mybinder.org/v2/gh/wan00967/psy8712-week8.git/HEAD.

An interactive web app is available by https://wan00967.shinyapps.io/shiny_week8/.
